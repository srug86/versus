...
namespace Versus.Core.Services.General
{
    public class NavigationService : INavigationService
    {
        ...
        protected virtual async Task InternalNavigateToAsync(Type viewModelType, object parameter)
        {
            ...
            if (page is MainView || page is SignInView)
            {
            ...
            else if (CurrentApplication.MainPage is MainView)
            {
                ...
                if (mainPage.Detail is VersusNavigationPage navigationPage)
                {
                ...
                {
                    navigationPage = new VersusNavigationPage(page);
            ...
            {
                var navigationPage = CurrentApplication.MainPage as VersusNavigationPage;
                ...
                {
                    CurrentApplication.MainPage = new VersusNavigationPage(page);
                }
            }
        ...
        {
            _mappings.Add(typeof(SignInViewModel), typeof(SignInView));
            _mappings.Add(typeof(MainViewModel), typeof(MainView));
            _mappings.Add(typeof(MenuViewModel), typeof(MenuView));
            _mappings.Add(typeof(MatchesViewModel), typeof(MatchesView));
        }
    }
}
